      ...
      >
        <div className="mx-auto max-w-content px-lg">
          ...
          <div className="pt-16 md:pt-20">
            {/* Desktop table */}
            <div className="hidden overflow-hidden rounded-sm bg-gallery-white shadow-sm ring-1 ring-minimal-line md:block">
            ...
            {/* Mobile: stacked cards (avoid overlap on small screens) */}
            <div className="md:hidden space-y-4 rounded-sm bg-gallery-white p-4 shadow-sm ring-1 ring-minimal-line">
              {profileRows.map((row) => (
                <div
                  key={row.label}
                  className="rounded-sm border-b border-minimal-line last:border-b-0 pb-4 last:pb-0"
                >
                  <p className="font-en mb-2 text-label uppercase tracking-[0.12em] text-steel-gray">
                    {row.label}
                  </p>
                  <p className="text-body leading-[1.9] text-obsidian-black">
                    {row.value}
                  </p>
                </div>
              ))}
